    ...
    local: {
      get: (keys) => {
        switch (browserType) {
          case FIREFOX:
          case CHROME:
            return self.crossplatform.storage.local.get(keys);
          default:
            return;
        }
      },
      set: (storageObject) => {
        switch (browserType) {
          case FIREFOX:
          case CHROME:
            return self.crossplatform.storage.local.set(storageObject);
          default:
            return;
        }
      },
      remove: (keys) => {
        switch (browserType) {
          case FIREFOX:
          case CHROME:
            return self.crossplatform.storage.local.remove(keys);
          default:
            return;
        }
      },
      clear: () => {
        switch (browserType) {
          case FIREFOX:
          case CHROME:
            return self.crossplatform.storage.local.clear();
          default:
            return;
        }
      }
